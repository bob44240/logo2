...
@Component({
  selector: 'app-logo-draw',
  templateUrl: './logo-draw.component.html',
  styleUrls: ['./logo-draw.component.css']
})
export class LogoDrawComponent implements OnInit {

  private canvasWidth = 480;
  private canvasHeight = 250;
  private margin = {top: 20, right: 20, bottom: 30, left: 40};
  private width = this.canvasWidth - this.margin.left - this.margin.right;
  private height = this.canvasHeight - this.margin.top - this.margin.bottom;
...
private rawFastaData = ' > 1 AGATCGACCCT > 2 GGAACGACGCT > 3GGATCGACCCT > 4CGATAGACGCT > 5CGATAGACGCT> 6GGATCGACCCT'
  ...
  ngOnInit() {
    ...
    // let maxBits = d3.max( this.data, function( d ) { return d.bitTotal } );
    ...
    // const column = this.svg.selectAll('.sequence-column')
    //   .data(this.data)
    //   .enter()
    //   .append('g')
    //   .attr('transform', function(d, i) { return 'translate(' + (this.x(i) + (this.x.rangeBand() / 2)) + ',0)'; })
    //   .attr('class', 'sequence-column');
    //
    // const capHeightAdjust  = 0.99;
    // const logoYAdjust      = 0.053;
    //
    //
    // column
    //   .selectAll('text')
    ...
    //   .enter()
    //   .append('text')
    //   .attr('y', function(e) { return this.y(e.y0) - (this.y(e.y0) - this.y(e.y1)) * logoYAdjust ; })
    //   .text( function(e) { return e.letter; } )
    //   .attr('class', function(e) { return 'letter-' + e.letter; } )
    //   .style( 'text-anchor', 'middle' )
    //   .style( 'font-family', 'sequencelogo' )
    //   .attr( 'textLength', this.x.rangeBand() )
    //   .attr( 'lengthAdjust', 'spacingAndGlyphs' )
    //   .attr( 'font-size', function(e) { return ( this.y(e.y0) - this.y(e.y1) ) * capHeightAdjust; } )
    //   .style( 'font-size', function(e) { return ( this.y(e.y0) - this.y(e.y1) ) * capHeightAdjust; } )
    //

  }

  sequencelogoFont() {
    const font = this.svg.append('defs').append('font')
